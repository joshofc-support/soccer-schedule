...
- **年の決まり方**：シート名に西暦が入っていれば（例：`2027年4月`）その年として読み込みます。年なしのシート名（例：`7月`）は `YEAR`（年度：4月〜翌3月、1〜3月は翌年扱い）で補完します。
- **次年度も同じファイルで運用できます。** 新しい年度のシートを `2027年4月`、`2027年5月`…（1〜3月は `2028年1月` のように実際の年）という名前で追加するだけで、コード変更は不要です。
